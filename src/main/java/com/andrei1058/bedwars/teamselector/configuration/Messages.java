...
public class Messages {
    ...
    public static void setupMessages() {
        for (Language l : Language.getLanguages()) {
            addDefault(l, GUI_NAME, "&7Team Selector", "&8Alege o Echipa");
            addDefault(l, SELECTOR_NAME, "&aTeam Selector &7(Right Click)", "&9Alege o Echipa");
            addDefault(l, SELECTOR_LORE, Collections.singletonList("&7Choose your team"), Collections.singletonList("&7Deschide cu click-dreapta!"));
            addDefault(l, CHOICE_LORE, Arrays.asList("&7Click to join the", "{color}{team} Team&7.", "", "&7Current players:", "&f{members}", "", "&eClick to join!"), Arrays.asList("", "&7&o{members}", "", "&eIntra cu Click!"));
            addDefault(l, CHOICE_NAME, "{color}{team} Team", "{color}{team} Team");
            addDefault(l, SWITCH_DISABLED, "", "");
            addDefault(l, TEAM_JOIN, "", "");
            addDefault(l, TEAM_FULL, "{prefix}&cFull!", "{prefix}&cEchipa {color}{team} &c este plina!");
            ...
            addDefault(l, CANT_JOIN_WHILE_STARTING, "{prefix}&cYou cannot join this team at the moment. The game is starting!", "{prefix}&cNu poti intra in aceasta echipa chiar acum. Incepe jocul!");
